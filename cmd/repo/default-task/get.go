...
func GetDefaultTaskCmd() *cobra.Command {
	var (
	...
	cmd := &cobra.Command{
		Use:   "get",
		Short: "Get default tasks for repository",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			values, err := client.GetDefaultTasks(repositories)
			if err != nil {
				client.Logger.Error(err.Error())
				return nil
			}

			return utils.PrintStructured("repositories", values, output, "projectKey,repositorySlug,defaultTasks.id,defaultTasks.description")
		},
	}
